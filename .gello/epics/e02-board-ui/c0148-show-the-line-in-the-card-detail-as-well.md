...
- [ ] **B — The whole live-status line the front shows** (whichever treatment currently applies: activity / countdown / waiting-on-slot / stopped / blocked), surfaced in the detail as one line. Consistent — the detail mirrors the front. *(My recommendation.)*
