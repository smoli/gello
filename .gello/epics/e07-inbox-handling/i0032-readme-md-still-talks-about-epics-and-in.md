...
- 2026-07-18 fixed (agent): swept the README to the current model (epics +
  inbox-as-status) — Concept → epics → cards, inbox is a status/first column,
  location = epic assignment (cards/ or epics/eNN/), triage prompts an epic
